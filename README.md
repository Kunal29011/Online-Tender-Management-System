...
Please make sure MySQL is running, and the database is set up.
Use Maven or Gradle to build the Spring Boot project (mvn clean install).
Run the Spring Boot application (mvn spring-boot:run).
Access the front end through your browser at http://localhost:8080/.
